  ...
  return (
    <div>
          ...
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <div className="mt-1">
                ...
                <p className="text-sm text-gray-500">out of {metrics.totalJobs} total jobs</p>
              </div>
            </div>
          </div>
          <div className="mt-4">
        ...
        <div className="rounded-lg bg-white p-6 shadow-md">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <div className="mt-1">
                <p className="text-2xl font-bold text-gray-900">{metrics.activeCandidates}</p>
                <p className="text-sm text-gray-500">out of {metrics.totalCandidates} total candidates</p>
              </div>
            </div>
          </div>
          <div className="mt-4">
        ...
        <div className="rounded-lg bg-white p-6 shadow-md">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <div className="mt-1">
                <p className="text-2xl font-bold text-gray-900">{metrics.submissions}</p>
      ...
      <div className="mb-8 rounded-lg bg-white p-6 shadow-md">
        <h3 className="mb-6 text-lg font-semibold text-gray-900">Pipeline Distribution</h3>
        <div className="grid grid-cols-5 gap-4">
          {Object.entries(metrics.pipeline).map(([stage, count]) => (
            <div key={stage} className="rounded-lg border border-gray-200 p-4 text-center">
              <p className="text-sm font-medium text-gray-600">{stage.charAt(0).toUpperCase() + stage.slice(1)}</p>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <div className="rounded-lg bg-white p-6 shadow-md">
          <h3 className="mb-4 text-lg font-semibold text-gray-900">Time to Fill</h3>
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-600">Fastest Fill Time</span>
              <span className="font-medium text-gray-900">-</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-600">Longest Fill Time</span>
              <span className="font-medium text-gray-900">-</span>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-lg bg-white p-6 shadow-md">
          <h3 className="mb-4 text-lg font-semibold text-gray-900">Interview Metrics</h3>
          <div className="space-y-4">
            <div className="flex items-center justify-between">
            ...
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-600">Average Interviews per Hire</span>
              <span className="font-medium text-gray-900">-</span>
            </div>
          </div>
        </div>
